...
def get_options(parser=argparse.ArgumentParser()):
    ...
    parser.add_argument('--dataset', type=str, default='airlines', help='Dataset')
    parser.add_argument('--datatype', type=str, default='realworld', help='The dataset is synthetic or not')

    # Method options
    parser.add_argument('--init_size', type=int, default=1200, help='Number of samples in the maximal class')
